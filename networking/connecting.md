...
2. [Client Connect](#0x07)
3. [Handshake Challenge](#0x04)
4. [Handshake Response](#0x09)
5. [Connection Response](#0x02)
...
{% include connect-packet-header.html name="Protocol Version" id="01" direction="server-to-client" %}
...
{% include connect-packet-header.html name="Client Connect" id="07" direction="client-to-server" compressed="true"%}
...
{% include connect-packet-header.html name="Handshake Challenge" id="04" direction="server-to-client" %}
...
{% include connect-packet-header.html name="Handshake Response" id="09" direction="client-to-server" %}
...
{% include connect-packet-header.html name="Connection Response" id="02" direction="server-to-client" %}
